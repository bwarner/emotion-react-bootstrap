...
class Carousel extends React.Component {
  ...
  render() {
    ...
    const outerClasses = [className, carousel, slideProp && slide];

    const innerClasses = carouselInner;
    ...
    if (slidesOnly) {
      return (
        <ClassNames>
          {({ cx }) => (
            <div
              className={cx(outerClasses)}
              onMouseEnter={this.hoverStart}
              onMouseLeave={this.hoverEnd}
            >
              {this.renderItems(children, cx(innerClasses))}
            </div>
          )}
        </ClassNames>
      );
        ...
        <ClassNames>
          {({ cx }) => (
            <div
              ...
              onMouseLeave={this.hoverEnd}
            >
              {this.renderItems(carouselItems, cx(innerClasses))}
              {controlLeft}
              {controlRight}
            </div>
          )}
...
export { default as CarouselIndicators } from './carousel-indicators';
