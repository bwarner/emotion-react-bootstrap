...
function Example1() {
  return (
    <Description title="Example" summary="Badges scale to match the size of the immediate parent element by using relative font sizing and em units.">
...
function Example2() {
  return (
    <Description title="Notifications" summary="Badges can be used as part of links or buttons to provide a counter.">
...
function Example3() {
  return (
    <Description title="Contextual variations" summary="Add any of the below mentioned modifier classes to change the appearance of a badge">
...
function Example4() {
  return (
    <Description title="Pill badges" summary="Use the pill attribute to make badges more rounded (with a larger border-radius and additional horizontal padding).">
...
function Example5() {
  return (
    <Description title="Links" summary="Using the contextual color names on an <a> provides actionable badges with hover and focus states.">
